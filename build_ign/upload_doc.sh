...
if [ ! -f "/home/claudia/ForestGuard/build_ign/doxygen/html/index.html" ]; then
  make doc
  if [ ! -f "/home/claudia/ForestGuard/build_ign/doxygen/html/index.html" ]; then
...
# Dry run
aws s3 sync --dryrun /home/claudia/ForestGuard/build_ign/doxygen/html/ s3://gazebosim.org/api/utils/1/
...
if [ "$ans" = "n" ] || [ "$ans" = "N" ]; then
  ...
  aws s3 sync /home/claudia/ForestGuard/build_ign/doxygen/html/ s3://gazebosim.org/api/utils/1/
